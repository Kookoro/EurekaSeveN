...
function SocialLink(props) {
  ...
  const showModal = (type) => {
    switch (type) {
      case "WX":
        setIsModalVisibleWX(true);
        break;
      case "QQ":
        setIsModalVisibleQQ(true);
        break;
      default:
        break;
    }
  ...
  return (
    <div className="icon-item">
      <svg
        ...
        p-id="6665"
        width={props.svgOption.width}
        height={props.svgOption.height}
      >
        <path
