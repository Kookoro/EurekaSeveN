    ...
    <div className="view-container">
      <div className="view-edit-container">
        <div className="view-editor">
          ...
          />
          <div className="editor-height-operator"></div>
        </div>
